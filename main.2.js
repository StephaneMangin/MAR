...
function start() {
    ...
    var vehicle, RC, Lights, Loader, car0, car1, car2, car3 = undefined;
    ...
    gui.add(text, 'Title');
    gui.add(text, 'Mass', 0, 500).onChange(function(value) {
        console.log("Mass changed: ", value);
        vehicle.mass = value
    })
    gui.add(text, 'Inertia', 0, 5).onChange(function(value) {
